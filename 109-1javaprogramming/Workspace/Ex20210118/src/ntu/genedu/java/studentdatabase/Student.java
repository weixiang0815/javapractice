...
public class Student implements FileInterface {
	// Field 欄位
	/**
	 * 學生姓名
	 */
	...
	public void saveFile(String fileName) throws IOException {
		...
		fw.write(this.name);
		fw.write(sp);
		fw.write(Integer.toString(this.chinese));
		fw.write(sp);
		fw.write(Integer.toString(this.english));
		fw.write(sp);
		fw.write(Integer.toString(this.math));
		fw.write(sp);
		fw.write(Integer.toString(this.getSum()));
		fw.write(sp);
		fw.write(Double.toString(this.getAverage()));
		fw.close();
